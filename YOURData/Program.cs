...
builder.Services.AddDbContext<AppDbContext>(o => o.UseMySql(cnn, MariaDbServerVersion.AutoDetect(cnn)));
...
else
{
  ...
  //app.Services.RenewDatabase<AppDbContext>();
  //app.Services.InitData<AppDbContext, AppUser>();
}
