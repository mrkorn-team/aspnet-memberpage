...
public static class core
{
  ...
  public static string urlibs => $"https://assets.{new Uri(core.urdomain).Host}/assets/libs";
  ...
  public static bool localhost => _localhost ??= new HttpContextAccessor()?.HttpContext?.Request.Host
    .Host.StartsWith(nameof(localhost), StringComparison.OrdinalIgnoreCase) ?? false;
